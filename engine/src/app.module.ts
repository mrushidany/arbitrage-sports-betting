...
import { BetikaAdapter } from './bookmakers/betika.adapter';
import { DbbetAdapter } from './bookmakers/dbbet.adapter';
...
@Module({
  ...
  providers: [
    ...
    DbbetAdapter,
    {
      ...
      inject: [SportybetAdapter, HelabetAdapter, BetikaAdapter, DbbetAdapter],
    },
    EventMatcherService,
    ArbitrageService,
    TelegramService,
